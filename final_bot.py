...
• Ссылка на бланк теста: https://docs.google.com/document/d/1-_QyS-ilpsAGhidHR0fURwLUnE4Leyhc/edit
"""
    elif call.data == 'soc':
        text = """
...
Здесь вы найдете:
• Презентации и лекции по географии / обществознанию
• Дополнительные материалы
• Материалы подготовки к зачёту
"""
